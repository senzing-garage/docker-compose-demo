...
1. Create
   [MsSQL compatible Docker images](https://github.com/senzing-garage/docker-wrap-image-with-mssql).
...
1. Set environment variables.
   Example:
    ...
    ```console
    export MSSQL_DIR=${SENZING_DEMO_DIR}/mssql
...
1. Create directories.
   Example:
    ...
    ```console
    mkdir -p ${MSSQL_DIR} ${SENZING_VAR_DIR}
...
1. Download `docker-compose.yaml`.
   Example:
    ...
    curl -X GET \
        ...
        "https://raw.githubusercontent.com/senzing-garage/docker-compose-demo/main/resources/mssql/docker-compose-kafka-mssql.yaml"
...
1. MSSQL is viewable at
   [localhost:9177](http://localhost:9177).
    ...
    1. **Database:** G2
1. See
   [additional tips](https://github.com/senzing-garage/knowledge-base/blob/main/lists/docker-compose-demo-tips.md#ms-sql)
...
1. *[senzing/adminer](https://github.com/senzing-garage/docker-adminer)*
...
- **[MSSQL_DATABASE](https://github.com/senzing-garage/knowledge-base/blob/main/lists/environment-variables.md#mssql_database)**
- **[MSSQL_DIR](https://github.com/senzing-garage/knowledge-base/blob/main/lists/environment-variables.md#mssql_dir)**
- **[MSSQL_PASSWORD](https://github.com/senzing-garage/knowledge-base/blob/main/lists/environment-variables.md#mssql_passwrod)**
- **[MSSQL_ROOT_PASSWORD](https://github.com/senzing-garage/knowledge-base/blob/main/lists/environment-variables.md#mssql_root-password)**
- **[MSSQL_USERNAME](https://github.com/senzing-garage/knowledge-base/blob/main/lists/environment-variables.md#mssql_username)**
