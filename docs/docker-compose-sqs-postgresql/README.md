...
1. Launch docker-compose formation.
   Example:
    ...
    sudo \
      --preserve-env \
      docker-compose --file resources/postgresql/docker-compose-sqs-postgresql.yaml up
    ```
...
1. Bring down docker formation.
   Example:
    ...
    sudo docker-compose --file resources/postgresql/docker-compose-sqs-postgresql.yaml down
    ```
