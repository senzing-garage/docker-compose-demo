...
1. Create
   [MySQL compatible Docker images](https://github.com/senzing-garage/docker-wrap-image-with-mysql/tree/main).
...
1. Download `docker-compose.yaml`.
   Example:
    ...
    curl -X GET \
        ...
        "https://raw.githubusercontent.com/senzing-garage/docker-compose-demo/main/resources/mysql/docker-compose-kafka-mysql.yaml"
