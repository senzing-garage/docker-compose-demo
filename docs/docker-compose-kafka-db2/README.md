...
1. :warning: This step is intentionally tricky and not simply copy/paste.
   ...
   Example:
    ...
    <code>
    export SENZING_ACCEPT_EULAX="[the value from [this link](https://github.com/Senzing/knowledge-base/blob/master/lists/environment-variables.md#senzing_accept_eula)]>"
    </code>
